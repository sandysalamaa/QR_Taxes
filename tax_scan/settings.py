"""
Django settings for tax_scan project.
...
SECRET_KEY = 'django-insecure-b0#&gldygvcn(@t#-epv^9dhxuvnm=09^vouyw@y32-j(m&tna'
...
# Disable Django's password validators
...
WSGI_APPLICATION = 'tax_scan.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.1/ref/settings/#databases

# DATABASES = { default django db
#     'default': {
